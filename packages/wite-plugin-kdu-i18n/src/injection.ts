...
import { isObject, isFunction, isRegExp, isString } from '@kdu-i18n/shared'

import type { Plugin, ResolvedConfig } from 'wite'

const debug = Debug('wite-plugin-kdu-i18n:kdu-i18n-kdu')

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export type InjectionValues = Record<string, any>

console.warn(
  `[@kdu-i18n/wite-i18n-kdu-i18n] KduI18nKdu plugin is experimental! This plugin is used for Kdu I18n Devtools. Don't use this plugin to enhancement Component options of your application.`
)
...
export default function KduI18nKdu(values: InjectionValues = {}): Plugin {
  let config: ResolvedConfig | null = null

  return {
    enforce: 'post',
    name: 'wite-plugin-kdu-i18n:kdu-i18n-kdu',
